  ...
  return (
    ...
    >
      ...
      {isMenuOpen && (
        <div
          className="
          items absolute top-[110px] h-screen w-full bg-beige shadow-[inset_0px_4px_18px_rgba(97,78,66,0.25)] transition-all duration-500"
        >
          <div className="ml-6 mt-[32px] flex flex-col gap-[26px] font-body-b1">
            {categories.map((category) => (
              <NavLink
                to={`categories/${category.name}`}
                className="z-40 my-2 font-medium tracking-[0.25em] text-[inherit] [text-decoration:none]"
              >
                {category.name}
              </NavLink>
            ))}
          ...
          <div className="ml-6 flex flex-col gap-[26px] font-body-b1">
            <NavLink
              to="/"
              className="z-40 my-2 font-medium tracking-[0.25em] text-[inherit] [text-decoration:none]"
            >
            ...
            <NavLink
              to="/"
              className="z-40 my-2 flex font-medium tracking-[0.25em] text-[inherit] [text-decoration:none]"
            >
              <svg
                width="20"
                height="20"
