...
function Navbar2(): JSX.Element {
  ...
  return (
    <nav
      className="
         fixed top-0 z-20 flex h-[148px] w-full bg-beige text-black-100 drop-shadow-xl transition-colors duration-500"
    >
          ...
          <div className="box-border flex w-full shrink-0 flex-row items-end justify-between overflow-hidden px-[108px] py-8 font-clash-grotesk text-5xl">
            <NavLink to="/" className="z-40 [text-decoration:none]">
              <svg
                ...
                className="
                   relative
                stroke-black-100 transition-colors duration-500"
              >
                <path
            ...
            <NavLink to="/" className="relative z-40 h-[30px] w-[30px]">
              <svg
                ...
                className="
                     relative
                  fill-black-100 transition-colors duration-500"
              >
