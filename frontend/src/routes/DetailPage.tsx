    ...
    <div className=" relative bg-beige w-full overflow-hidden flex flex-col items-center justify-start gap-[176px] text-left text-5xl text-black-200 font-clash-grotesk">
      ...
      <div className="bg-white w-[1728px] overflow-hidden flex flex-row py-[53px] px-[188px] box-border items-baseline justify-between z-[2]">
        <div className="flex flex-row items-start justify-start gap-[240px]">
          <div className="relative w-[279px] h-[30px]">
            <div className="absolute top-[0%] left-[0%] tracking-[0.25em]">
              PRODUCT DETAILS
            </div>
          </div>
          ...
          <div className="relative w-[323px] h-[30px]">
            <div className="absolute top-[0%] left-[0%] tracking-[0.25em]">
              COMPLETE THE LOOK
            </div>
          </div>
      ...
      <div className="flex flex-col items-center justify-start gap-[32px] z-[3] text-29xl font-body-b1">
        ...
        <div className="h-[236px] flex flex-row items-start justify-start text-5xl">
          ...
          <div className="w-[1296px] h-[236px] overflow-hidden shrink-0 flex flex-col py-[57px] pr-11 pl-[113px] box-border items-start justify-center gap-[32px]">
      ...
      <div className="flex flex-col items-center justify-start gap-[13px] z-[4]">
        <div className="flex flex-col items-center justify-start relative gap-[103px]">
          <div className="relative w-[1728px] h-[822px] z-[0]">
            <img
              className="absolute top-[0px] left-[0px] w-[1129px] h-[822px] object-cover"
              alt=""
              src="/rectangle-110@2x.png"
            />
            <img
              className="absolute top-[0px] left-[1142px] w-[586px] h-[822px] object-cover"
              alt=""
      ...
      <ReviewsSection />
      <LookCompleter />
      <button className="cursor-pointer py-4 px-16 bg-[transparent] rounded-31xl box-border h-[72px] flex flex-row items-center justify-center z-[7] border-[4px] border-solid border-brown">
        <div className="relative text-5xl tracking-[0.15em] font-medium font-clash-grotesk text-brown text-left">
          Explore more
        </div>
      </button>
      <div className="relative w-[1728px] h-[945px] z-[8]">
        <SignupForm />
        <CustomerCareContainer />
      </div>
      <button className="cursor-pointer py-4 px-14 bg-[transparent] my-0 mx-[!important] absolute top-[209px] left-[48px] rounded-31xl box-border h-[72px] flex flex-row items-center justify-center gap-[8px] z-[9] border-[4px] border-solid border-brown">
