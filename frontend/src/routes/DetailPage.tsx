...
const DetailPage: FunctionComponent = () => {
  ...
  return (
    <div className=" relative bg-beige w-full overflow-hidden flex flex-col items-center justify-start gap-[226px] text-left text-5xl text-black-200 font-clash-grotesk">
        ...
        <div className="flex flex-row items-start justify-start gap-[240px]">
          ...
          <div className="flex flex-col items-center justify-start gap-[32px] z-[3] text-29xl font-body-b1">
            ...
            <div className="h-[236px] flex flex-row items-start justify-start text-5xl">
              <div className="w-[332px] h-[212px] overflow-hidden shrink-0 flex flex-col py-[57px] pr-11 pl-[135px] box-border items-start justify-center gap-[32px]">
              ...
              <div className="w-[1196px] h-[212px] overflow-hidden shrink-0 flex flex-col py-[57px] pr-11 pl-[113px] box-border items-start justify-center gap-[32px]">
      ...
      <div className="flex flex-col items-center justify-start gap-[64px] z-[4]">
        <div className="flex flex-col items-center justify-start relative gap-[103px]">
          <div className="relative w-[1850px] h-[822px] z-[0]">
            <img
              className="absolute top-[0px] left-[50px] w-[1129px] h-[822px] "
              alt=""
              src="/rectangle-110@2x.png"
            />
            <img
              className="absolute top-[0px] left-[1200px] w-[586px] h-[822px] object-cover"
              alt=""
              src="/rectangle-112@2x.png"
            />
          </div>
          <div className="absolute my-0 mx-[!important] top-[-0.43px] left-[1193px] bg-beige w-[64px] h-[822px] z-[1]" />
        </div>
        <img
